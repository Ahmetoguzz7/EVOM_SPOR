...
class _NotificationsScreenState extends State<NotificationsScreen>
  ...
  Future<void> _sendNotification() async {
    ...
    if (dbSuccess) {
      _showSnackBar(
        "✅ Duyuru gönderildi!${_sendLocalNotification ? " (Telefona da bildirim geldi)" : ""}",
      );
...
class _NotificationsScreenState extends State<NotificationsScreen>
  ...
  Future<Map<String, dynamic>> _loadDataParallel() async {
    ...
    // Tüm verileri paralel çek (2 işlem aynı anda)
  ...
  Widget _buildSendNotificationTab() {
    return FutureBuilder<Map<String, dynamic>>(
      future: _loadDataParallel(), // 🔥 PARALEL VERSİYON
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
          return const Center(child: CircularProgressIndicator());
        }
