/*
  Bu sayfa, öğrencinin yoklama geçmişini detaylı bir şekilde gösterir.
  - Farklı zaman filtreleri (haftalık, aylık, yıllık) ile yoklama verilerini inceleme
  - Grafik ve liste görünümü seçenekleri
  - Yoklama oranı ve toplam kaçırılan/katılan ders sayısı gibi özet bilgiler
  - Veriler Google Sheets'ten çekilir ve kullanıcıya özel olarak filtrelenir
*/
/*
...
class _StudentAttendancePageState extends State<StudentAttendancePage>
  ...
  void _applyFilter() {
    ...
    if (_selectedFilter == "Tümü") {
      ...
      _filteredAttendances = _allAttendances.where((a) {
    ...
    setState(() {
      _totalClasses = _filteredAttendances.length;
