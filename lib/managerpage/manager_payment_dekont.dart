        ...
        content: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text("Geçmişe Yönelik (Çoklu Ay)"),
              subtitle: const Text(
                "Sadece seçilen ayların ücretini değiştirir",
              ),
          ...
          return AlertDialog(
            ...
            title: const Row(
              children: [
                Icon(Icons.edit, color: _teal),
                SizedBox(width: 8),
                Text('Gelecek Aylar İçin Ücret Güncelle'),
              ],
            ),
            content: Column(
              mainAxisSize: MainAxisSize.min,
          ...
          return AlertDialog(
            ...
            title: const Row(
              children: [
                ...
                SizedBox(width: 8),
                Text('Geçmiş Aylar İçin Toplu Ücret Düzeltme'),
              ],
            ),
            content: SingleChildScrollView(
              child: Column(
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          const Text(
                            "Ayları Seçin (Birden fazla seçebilirsiniz)",
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(height: 12),
                          Wrap(
